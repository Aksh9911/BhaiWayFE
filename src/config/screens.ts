...
export const ROOT_SCREENS = {
  ...
  verifyAadhaar: {
    id: 'verify-aadhaar',
    segment: 'verify-aadhaar',
    path: '/verify-aadhaar',
    title: 'Verify Aadhaar',
  },
  verifyAadhaarSuccess: {
    id: 'verify-aadhaar-success',
    segment: 'verify-aadhaar-success',
    path: '/verify-aadhaar-success',
...
export const RIDE_SEARCH_SCREENS = {
  ...
  addUpi: {
    id: 'ride-search-add-upi',
    segment: 'add-upi',
    path: '/ride-search/add-upi',
    title: 'Add New UPI ID',
  },
  addCard: {
    id: 'ride-search-add-card',
    segment: 'add-card',
    path: '/ride-search/add-card',
    title: 'Add New Card',
  },
  seeAllBanks: {
    id: 'ride-search-see-all-banks',
    segment: 'see-all-banks',
    path: '/ride-search/see-all-banks',
    title: 'See All Banks',
  },
  booked: {
...
export const OFFER_RIDE_SCREENS = {
  ...
  preferences: {
    id: 'offer-ride-preferences',
    segment: 'preferences',
    path: '/offer-ride/preferences',
    title: 'Ride Preferences',
  },
  payment: {
    id: 'offer-ride-payment',
    segment: 'payment',
    path: '/offer-ride/payment',
    title: 'Payment Options',
  },
  published: {
    id: 'offer-ride-published',
    segment: 'published',
    path: '/offer-ride/published',
...
export const MY_RIDES_SCREENS = {
  ...
  riderAccepted: {
    id: 'my-rides-rider-accepted',
    segment: 'rider-accepted',
    path: '/my-rides/rider-accepted',
    title: 'Rider Request Accepted',
  },
  declineRider: {
    id: 'my-rides-decline-rider',
    segment: 'decline-rider',
    path: '/my-rides/decline-rider',
    title: 'Decline Request',
  },
  requestDeclined: {
    id: 'my-rides-request-declined',
    segment: 'request-declined',
    path: '/my-rides/request-declined',
    title: 'Request Declined',
  },
  modifyRide: {
    id: 'my-rides-modify-ride',
    segment: 'modify-ride',
    path: '/my-rides/modify-ride',
    title: 'Modify Outstation Ride',
  },
  tripDetails: {
    id: 'my-rides-trip-details',
    segment: 'trip-details',
    path: '/my-rides/trip-details',
    title: 'Trip Details',
  },
  ratePassengers: {
    id: 'my-rides-rate-passengers',
    segment: 'rate-passengers',
    path: '/my-rides/rate-passengers',
    title: 'Rate Your Passengers',
  },
  ratingsSubmitted: {
    id: 'my-rides-ratings-submitted',
    segment: 'ratings-submitted',
    path: '/my-rides/ratings-submitted',
    title: 'Submission Status',
  },
  invoice: {
    id: 'my-rides-invoice',
    segment: 'invoice',
    path: '/my-rides/invoice',
    title: 'Invoice',
  },
  reportIssue: {
    id: 'my-rides-report-issue',
    segment: 'report-issue',
    path: '/my-rides/report-issue',
    title: 'Report Issue',
  },
  issueReported: {
    id: 'my-rides-issue-reported',
    segment: 'issue-reported',
    path: '/my-rides/issue-reported',
...
export const OFFICE_COMMUTE_SCREENS = {
  ...
  cancelRide: {
    id: 'office-commute-cancel-ride',
    segment: 'cancel-ride',
    path: '/office-commute/cancel-ride',
    title: 'Cancel Ride',
  },
  cancelConfirmed: {
    id: 'office-commute-cancel-confirmed',
    segment: 'cancel-confirmed',
    path: '/office-commute/cancel-confirmed',
    title: 'Ride Cancelled',
  },
} as const satisfies Record<string, ScreenDefinition>;
...
export const AUTH_SCREENS = {
  ...
  verifyAadhaar: {
    id: 'login-verify-aadhaar',
    segment: 'verify-aadhaar',
    path: '/login/verify-aadhaar',
    title: 'Verify Aadhaar',
  },
  verifyAadhaarSuccess: {
    id: 'login-verify-aadhaar-success',
    segment: 'verify-aadhaar-success',
    path: '/login/verify-aadhaar-success',
    title: 'Identity Verified',
  },
} as const satisfies Record<string, ScreenDefinition>;
...
export const ROUTES = {
  ...
  authFaq: AUTH_SCREENS.faq.path,
  otp: AUTH_SCREENS.otp.path,
  completeProfile: AUTH_SCREENS.profile.path,
  authVerifyAadhaar: AUTH_SCREENS.verifyAadhaar.path,
  authVerifyAadhaarSuccess: AUTH_SCREENS.verifyAadhaarSuccess.path,
  profile: ROOT_SCREENS.masterProfile.path,
  demoData: ROOT_SCREENS.demoData.path,
  ...
  rideSearchAddUpi: RIDE_SEARCH_SCREENS.addUpi.path,
  rideSearchAddCard: RIDE_SEARCH_SCREENS.addCard.path,
  rideSearchSeeAllBanks: RIDE_SEARCH_SCREENS.seeAllBanks.path,
  ...
  officeCommuteCancelRide: OFFICE_COMMUTE_SCREENS.cancelRide.path,
  officeCommuteCancelConfirmed: OFFICE_COMMUTE_SCREENS.cancelConfirmed.path,
  ...
  offerRidePreferences: OFFER_RIDE_SCREENS.preferences.path,
  offerRidePayment: OFFER_RIDE_SCREENS.payment.path,
  offerRidePublished: OFFER_RIDE_SCREENS.published.path,
  ...
  myRidesTrack: MY_RIDES_SCREENS.track.path,
  myRidesRiderAccepted: MY_RIDES_SCREENS.riderAccepted.path,
  myRidesDeclineRider: MY_RIDES_SCREENS.declineRider.path,
  myRidesRequestDeclined: MY_RIDES_SCREENS.requestDeclined.path,
  myRidesModifyRide: MY_RIDES_SCREENS.modifyRide.path,
  myRidesTripDetails: MY_RIDES_SCREENS.tripDetails.path,
  myRidesRatePassengers: MY_RIDES_SCREENS.ratePassengers.path,
  myRidesRatingsSubmitted: MY_RIDES_SCREENS.ratingsSubmitted.path,
  myRidesInvoice: MY_RIDES_SCREENS.invoice.path,
  myRidesReportIssue: MY_RIDES_SCREENS.reportIssue.path,
  myRidesIssueReported: MY_RIDES_SCREENS.issueReported.path,
  ...
  walletTransactions: ROOT_SCREENS.walletTransactions.path,
  withdraw: ROOT_SCREENS.withdraw.path,
  addMoney: ROOT_SCREENS.addMoney.path,
  fundsAdded: ROOT_SCREENS.fundsAdded.path,
  linkUpi: ROOT_SCREENS.linkUpi.path,
  upiLinked: ROOT_SCREENS.upiLinked.path,
  ...
  verifyAadhaar: ROOT_SCREENS.verifyAadhaar.path,
  verifyAadhaarSuccess: ROOT_SCREENS.verifyAadhaarSuccess.path,
