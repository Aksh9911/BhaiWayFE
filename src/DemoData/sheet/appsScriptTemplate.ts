 ...
 * then paste the Web App URL into EXPO_PUBLIC_GOOGLE_SHEETS_WEBHOOK_URL.
 *
 * Canonical paste file: `src/DemoData/files/google-sheet-apps-script.js`
 * Shared IDs/headers: `src/DemoData/files/demoData.common.ts`
 */

import { DEMO_GOOGLE_SHEET_ID } from '../files';

export const USER_DETAILS_SHEET_APPS_SCRIPT = `
